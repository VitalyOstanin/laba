...
Desktop GUI for taskstream — a multi-backend task tracker client (OpenProject,
GitHub). Built with Tauri v2 and SvelteKit (Svelte 5, adapter-static SPA). The
GUI drives the shared `taskstream-core` crate for backend access and reuses the
